...
## Revised Techtree and Unit Upgrade Tree (done):
...
## Graphic/Tileset (WIP, mostly done)

The only unit tileset Regnum Germaniae supports will be HexaRealm. And there will be new unit sprites (in HexaRealm style) for every new and modified units of this mod.

Reskin generic units to fit in the theme of the mod.
...
## Holy Roman Empire System (WIP, partly done)

World Congress/United Nation system will be modified into the Holy Roman Empire.

## Rework the religion, city states to fit in the theme of the mod (Done)
...
* Pjokolom: sprites of Wagenburg, Flailman, Galleon, Schwertbruder, Cruiser, Landship-Russia.
...
* Uighur_Caesar: author of Civ 5 mod "Teutonic Order", for texts and some ideas of TO.
...
* Studio Danro, Bacontaco, Icon Designer, Smashicons, Firza Alamsyah, Marco Livolsi, IconMark, bis kim, Amethyst Studio, ProSymbols,Vectorstal, Adrien Coquet, BnB Studio, Anna Weiss, Brickclay, Linseed Studio, A184, Ary Prasetyo, Chiara Claus, Andy Horvath, Mia Elysia, Phạm Thanh Lộc, Muhammad Atiq, Vectors Market, Lewen Design, Cuan Studio, Izwar Muis, Singlar, Maxicons, Ishaq_hmad, Smalllike, jabbar, Gregor Cresnar, HIMMATUL ULIYAH, M. Oki Orlandom, Ar2ar, Circlon Tech, Cédric Villain, aqqinqin, Rahmat Sigit Prasetyo, Kamila Lejman, Arkinasi, Resa Valen, Stephen Plaster, Leif Michelsen, nine, Tetiana Mykhailyk, Adinda, Izwar Muis, dolgran: icons